import { stringContainUppercase } from "./containUppercase";
...
describe("stringContainUppercase.", (): void => {
  ...
  it("4. Returns true when the string contains only lowercase and uppercase letters.", (): void => {
    const result: boolean = stringContainUppercase("abcABC");

    assert.equal(result, true);
  });

  it("5. Return false when the string contains letters and numbers.", (): void => {
    const result: boolean = stringContainUppercase("abc123");
  ...
  it("8. Return false when the string is empty.", (): void => {
    const result: boolean = stringContainUppercase("");

    assert.equal(result, false);
  });

  it("9. Return false when the string contains only numbers characters.", (): void => {
    const result: boolean = stringContainUppercase("123");
  ...
  it("12. Return true when the string contains whitespace and letters.", (): void => {
    const result: boolean = stringContainUppercase("abc ABC");

    assert.equal(result, true);
  });

  it("13. Return false when the string contains whitespace, letters and non-letter characters.", (): void => {
    const result: boolean = stringContainUppercase("abc 123");
  ...
  it("15. Return false when the string contains accented letters.", (): void => {
    const result: boolean = stringContainUppercase("áÁèÈïÏ");

    assert.equal(result, false);
  });

  it("16. Return false when input is a string with unicode characters.", (): void => {
    const result: boolean = stringContainUppercase("世界");
